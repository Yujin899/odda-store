...
### 🏗️ Strict Leaf Component Architecture
...
### ⚡ Edge Caching & Revalidation Orchestration
...
- **Bilingual Intent Strategy**: We target two distinct search profiles in our metadata:
    1. **Formal Brand Intent**: Branded keywords using the correct glyphs (**عُدّة**).
    2. **Common Search Volume**: High-traffic plain-text variants (**عدة**) to capture broad intent.
...
### 🌍 Server-Side Direction Integrity
