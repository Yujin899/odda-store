...
export function RegisterClient({ dict, language }: RegisterClientProps) {
        ...
        <div className="bg-white border border-slate-100 p-10 rounded-(--radius) shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full h-14 bg-foreground text-background flex items-center justify-center gap-3 font-black text-[10px] uppercase tracking-[0.3em] rounded-(--radius) shadow-xl hover:-translate-y-0.5 transition-all active:scale-[0.98] mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="pt-4 text-center">
            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
              ...
              <Link href="/login" className="text-(--primary) font-black">Login Instead</Link>
            </p>
          </div>
        </div>
      </motion.div>
