      ...
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          ...
          <Tooltip 
            ...
            formatter={(value: any, name: any) => [value, FORMAT_STATUS[name] || name]}
          />
          <Legend 
            verticalAlign="bottom" 
            height={36}
            formatter={(value) => <span style={{ color: 'var(--muted-foreground)', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{FORMAT_STATUS[value] || value}</span>}
          />
        </PieChart>
      </ResponsiveContainer>
    </div>
