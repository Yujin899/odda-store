...
export function SettingsForm({ initialData }: { initialData?: any }) {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmationSubjectAr: initialData?.confirmationSubjectAr || "أودا - تأكيد الطلب رقم {{orderNumber}}",
    ...
    shippedSubjectAr: initialData?.shippedSubjectAr || "أودا - تم شحن طلبك رقم {{orderNumber}}!",
